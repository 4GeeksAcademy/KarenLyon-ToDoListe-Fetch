...
const Input = () => {
    ...
    // Primero, hacemos la solicitud DELETE para borrar el elemento
    ...
    return (
        <div className="back">
            ...
            <ul>
                <li >
                    <input type="text" value={inputValue} onChange={(e)=>{setInputValue(e.target.value)}} placeholder="Write your new task"
                        onKeyDown={(e)=>{
                            if(e.key==="Enter"){
